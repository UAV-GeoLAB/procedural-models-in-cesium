...
```
cd existing_repo
git remote add origin https://gitlab.cenagis.edu.pl/uavgeolab/pac/procedural-models-in-cesium.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cenagis.edu.pl/uavgeolab/pac/procedural-models-in-cesium/-/settings/integrations)
